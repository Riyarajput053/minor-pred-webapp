...
if selected == 'Diabetes Prediction':  # pagetitle
    ...
    if st.button("Diabetes test result"):
        ...
        if diabetes_prediction[0] == 1:
            diabetes_dig = "Our analysis suggests a potential presence of diabetes. Please consult your doctor for further evaluation."
            image = Image.open('positive.jpg')
            st.image(image, caption='')
        else:
            diabetes_dig = "No signs of diabetes were detected in our analysis. Remember to maintain a healthy lifestyle."
...
if selected == 'Heart disease Prediction':
    ...
    if st.button("Heart test result"):
        ...
        if heart_prediction[0] == 1:
            heart_dig = "Our analysis suggests a potential presence of Heart Disease. Please consult your doctor for further evaluation."
            image = Image.open('positive.jpg')
            st.image(image, caption='')
            
        else:
            heart_dig = "No signs of Heart disease were detected in our analysis. Remember to maintain a healthy lifestyle."
            image = Image.open('negative.jpg')
            st.image(image, caption='')
   ...
   # change the variables according to the dataset used in the model
    ...
    if st.button("Parkinson test result"):
        ...
        if parkinson_prediction[0] == 1:
            parkinson_dig = "Our analysis suggests a potential presence of Parkinson disease. Please consult your doctor for further evaluation."
            image = Image.open('positive.jpg')
            st.image(image, caption='')
        else:
            parkinson_dig ="No signs of Parkinson were detected in our analysis. Remember to maintain a healthy lifestyle."
            image = Image.open('negative.jpg')
            st.image(image, caption='')
...
if selected == 'Lung Cancer Prediction':
    ...
    if st.button("Predict Lung Cancer"):
        ...
        if cancer_prediction[0] == 'YES':
            cancer_result = "Our analysis suggests a potential presence of lung disease. Please consult your doctor for further evaluation."
            image = Image.open('positive.jpg')
            st.image(image, caption='')
        else:
            cancer_result = "No signs of Lung disease were detected in our analysis. Remember to maintain a healthy lifestyle."
            image = Image.open('negative.jpg')
            st.image(image, caption='')
...
# st.write(info.astype(int).info())
    ...
    if st.button("Liver test result"):
        ...
        if liver_prediction[0] == 1:
            image = Image.open('positive.jpg')
            st.image(image, caption='')
            liver_dig = "Our analysis suggests a potential presence of liver disease. Please consult your doctor for further evaluation."
        else:
            image = Image.open('negative.jpg')
            st.image(image, caption='')
            liver_dig = "No signs of Liver disease were detected in our analysis. Remember to maintain a healthy lifestyle."
...
if selected == 'Hepatitis prediction':
    ...
    if st.button("Predict Hepatitis"):
        ...
        if hepatitis_prediction[0] == 1:
            hepatitis_result = "Our analysis suggests a potential presence of Hepatitis. Please consult your doctor for further evaluation."
            image = Image.open('positive.jpg')
            st.image(image, caption='')
        else:
            hepatitis_result = "No signs of Hepatitis were detected in our analysis. Remember to maintain a healthy lifestyle."
            image = Image.open('negative.jpg')
            st.image(image, caption='')
...
#             image = Image.open('positive.jpg')
#             st.image(image, caption='')
#             kidney_prediction_dig = "Our analysis suggests a potential presence of kidney disease. Please consult your doctor for further evaluation."
#         else:
#             image = Image.open('negative.jpg')
#             st.image(image, caption='')
#             kidney_prediction_dig = "No signs of kidney disease were detected in our analysis. Remember to maintain a healthy lifestyle."
